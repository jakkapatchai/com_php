...
<div class="bgded overlay light" style="background-image:url('back.jpg');"> 
  ...
  <div id="pageintro" class="hoc clear"> 
    <article>
      ...
      <h3 class="heading">Jakkapat Chaikaeo</h3>
      <p>Nation Univercity</p>
    </article>
  </div>
...
<div class="wrapper row4">
  <footer id="footer" class="hoc clear"> 
    <div class="one_quarter">
      <h6 class="heading">ช่องทางติดต่อ</h6>
      <ul class="faico clear">
        <li><a class="faicon-facebook" href="https://www.facebook.com/jakkapatcom/"><i class="fa fa-facebook"></i></a></li>
